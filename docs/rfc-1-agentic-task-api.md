...
| 3 | Standard Error Format | Compliant | All errors follow `{ error, code, message, details, suggestion, retry_after, _links }`. 23 error codes documented at `GET /errors`. See Section 3.10. |
